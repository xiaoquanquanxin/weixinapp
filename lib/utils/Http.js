                    ...
                    Modal.alert('提示', "超时请重新登录", [
                        {
                            text: '确定', onPress: () => {
                                ...
                                window.location.href = "#/SubmitCertification";
        ...
        return new Promise(function (resolve, reject){
            ...
            window.JQ.ajax({
                ...
                statusCode: {//http状态处理方法
                    403: function (){
                        console.log(`需要认证，跳转到${location.hash.split('#')[1]}`);
                        //  todo    有风险
                        window.location.href = "#/HouseAuthentication?url=" + encodeURIComponent(location.hash.split('#')[1]);
                    },
                    401: function (){
