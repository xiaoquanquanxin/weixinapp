 ...
 export default class TopBar extends React.Component {
	...
	render() {
		...
		return (<div className="Components-TopBar-container">
			<div className={'topbar'} style={{lineHeight: window.OSInfo()=='android'? lineHeightValue+'px': 'auto', backgroundColor: (this.props.opacity==1 || !this.props.opacity)  ?'#1A2C52': 'transparent'}}>
				{
					this.props.left ? <div style={{width:45}}> &nbsp;</div>: <div className="item" onClick={this.goback}> <span className="icon font_family"> &#xe662;</span></div>
				}
