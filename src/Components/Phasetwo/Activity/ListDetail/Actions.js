...
class Actions {
    ...
    Noticefun = async (id, history) => {
        ...
        //let result = await window.GET({ url: "user/activity/activitiDetail", cformData, fun401:true });
        let result = await window.GET({url: "user/activity/activityDetail", cformData,});
