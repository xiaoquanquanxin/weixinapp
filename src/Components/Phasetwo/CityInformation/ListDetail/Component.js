...
@observer
export default class PhasetwoCityInformationListDetail extends React.Component {
    componentDidMount(){
    ...
    render() {
        ...
        const { storePhasetwoCityInformationListDetail} = store;
        const { actionsPhasetwoCityInformationListDetail} = actions;
        //const { setnoticeDetail } = actionsListDetail;
        const { setnoticeDetail } = storePhasetwoCityInformationListDetail
