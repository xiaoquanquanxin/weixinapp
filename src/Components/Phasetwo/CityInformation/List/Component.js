...
export default class PhasetwoCityInformationList extends React.Component {
    componentDidMount() {
        ...
        this.props.actions.actionsPhasetwoCityInformationList.listProvide()
    }
    render() {
            ...
            <div className={"list"}>
                {
                        ...
                        return (
                            <div className={"item"} key={i} onClick={() => { itemfun(history,v) }}>
                                <div className={"right"}>
                ...
                {/* <div className={"item item2"}>
                    ...
                    <div className={"img3"}>
                        <div className={"img"}><img src={listimg1} /></div>
                        <div className={"img"}><img src={listimg1} /></div>
                        <div className={"img"}><img src={listimg1} /></div>
                    </div>
