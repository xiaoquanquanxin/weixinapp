...
export default class PhasetwoArticle extends React.Component {
    componentDidMount(){
        ...
        this.props.actions.actionsPhasetwoArticle.setnoticeDetail(this.props.match.params.id)
        let that=this;
            ...
            <div className="content-wrap">
                <div className="content">
                    ...
                    {setnoticeDetail.originalLink&&
                        <div className={"readTextc"} onClick={() => { readText(setnoticeDetail.originalLink, history) }}>阅读原文</div>
                    }
