...
export default class PhasetwoMyQuestionnaire extends React.Component {
    componentDidMount(){
		...
		window.setTimeout(()=>{
			...
			window.setLocalData("isDone", isDones);//存儲token值
                                ...
                                {v.questionType == 4 &&false&&
                                    ...
                                    <div className={"tit Textareatit"}>{i + 1}、{v.questionDesc}</div>
                                    {
                                        ...
                                        <ImagePickerWX
                                            ...
                                            apidel={""}
                                            ImgItemClosefun={(ImgItemdata) => { ImgItemdatafun(ImgItemdata,i) }}
                                        ...
                                        <div className={"imgarr"}>
                                            {
                                                    ...
                                                    return(
                                                        <div className={"imgwidth"} key={ii} onClick={() => { this.props.onClick(vv) }}>
                                                            <img src={vv}  />
                                                        </div>
                                                    )
                                                })
