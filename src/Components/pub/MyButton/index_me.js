...
class Mybutton extends React.Component {
    ...
    render() {
        ...
        return <Button inline style={{width:`${heightAndWidth.width/100}rem`,height:`${heightAndWidth.height}px`}} type="primary" className={colorStyle()} onClick={this.props.callback.bind(this)}>{label}</Button>
    }
}
